...
import com.example.akujobijoshua.StudentBuddy.LoginActivity;
import com.example.akujobijoshua.StudentBuddy.MainActivity;
...
// Storing id in pref
    ...
    public void checkLogin(){
        ...
        }else{Intent i=new Intent(_context,Homepage.class);
            i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
