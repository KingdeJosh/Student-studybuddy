 ...
 */
public class TaskDueFragment extends Fragment {


    public TaskDueFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_task_due, container, false);
        ...
        classList = Database.getTodaysClasses(getContext(),dateFormat.format(cal.getTime()),"Reading");
